...
export default function ActivityDashboard({ activities, selectedActivity, selectActivity, cancelActivity, CreateOrEdit, DeleteActivity, editMode, FormOpen, FormClose }: Props) {
